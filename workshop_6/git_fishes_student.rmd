...
It doesnt back up your files? 
Intended to be version control
...
# Write your answer here
It no longer appears in the rendered html file
```
...
data_clean <- subset(data_clean, select = -c(X, comment))
...
data_clean %>% 
  ...
  summarise(mean_sl = mean(sl), 
            ...
            se_sl = sd(sl)/length(sl),
            se_activity = sd(activity)/length(activity))
