...
```{r, answer6}
# No, because they are available to re-download from the original paper
```
...
t.test(activity ~ treatment, data = filter(data_clean, species == "acantho"))
summary(aov(activity ~ treatment, data = filter(data_clean, species == "acantho")))

t.test(activity ~ treatment, data = filter(data_clean, species == "ambon"))
t.test(activity ~ treatment, data = filter(data_clean, species == "chromis"))
t.test(activity ~ treatment, data = filter(data_clean, species == "humbug")) # 
t.test(activity ~ treatment, data = filter(data_clean, species == "lemon"))
t.test(activity ~ treatment, data = filter(data_clean, species == "whitedams"))
```
